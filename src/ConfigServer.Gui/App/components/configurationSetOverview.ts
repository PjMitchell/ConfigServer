...
@Component({
    ...
    template: `
        <div class="group">
            ...
            <button type="button" class="btn btn-primary" (click)="downloadConfigSet(configurationSet.configurationSetId)"> <span class="glyphicon glyphicon-download-alt"></span> </button>
